...
def run(sources, nsources, receivers, nreceivers, outrays, outtts):
    ...
    Defined at 3dfm_main.f90 lines 14-1387
    ...
    """
    _fm3d.f90wrap_run(sources=sources, nsources=nsources, receivers=receivers, \
...
def initialize_velocity_grids(vgrids, ngrids, ntypes, nr, nlambda, nphi, r0, \
    ...
    """
    _fm3d.f90wrap_initialize_velocity_grids(vgrids=vgrids, ngrids=ngrids, \
...
def initialize_propagation_grid(nr, nlat, nlon, dr, dlat, dlon, h0, lat0, lon0):
    ...
    Defined at 3dfmlib.f90 lines 104-197
    ...
    """
    _fm3d.f90wrap_initialize_propagation_grid(nr=nr, nlat=nlat, nlon=nlon, dr=dr, \
...
def initialize_interfaces(lambda0, phi0, nlambda, nphi, dlambda, dphi):
    ...
    Defined at 3dfmlib.f90 lines 204-305
    ...
    """
    _fm3d.f90wrap_initialize_interfaces(lambda0=lambda0, phi0=phi0, nlambda=nlambda, \
        nphi=nphi, dlambda=dlambda, dphi=dphi)
